...
public class Coin extends TimerTask {
	...
	public static void genCoin() {
		...
		} else if ((rX2 == Spike.spike_x[0])
				&& (rY2 == Spike.spike_y[0] || (rX2 == Spike.spike_x[1]) && (rY2 == Spike.spike_y[1])
		...
		} else if ((rX2 == Food.foodC_x) && (rY2 == Food.foodC_y) || (rX2 == Food.foodY_x) && (rY2 == Food.foodY_y)
